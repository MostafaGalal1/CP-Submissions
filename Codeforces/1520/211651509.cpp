        ...
        if (cnt) {
            ...
            for (int i = av; i >= 0; --i) {
                if (s[i] == '.')
                    ...
                    res += ql.front() - i, ql.pop(), s[i] = '.', i++;
            }
            for (int i = av+1; i < n; ++i) {
                if (s[i] == '.')
                    qr.push(i);
                else if (!qr.empty())
                    res += i - qr.front(), qr.pop(), s[i] = '.', i--;
            }
            ...
            for (int i = av-1; i >= 0; --i) {
                if (s[i] == '.')
                    ...
                    res1 += ql.front() - i, ql.pop(), s[i] = '.', i++;
            }
            for (int i = av; i < n; ++i) {
                if (s[i] == '.')
                    qr.push(i);
                else if (!qr.empty())
                    res1 += i - qr.front(), qr.pop(), s[i] = '.', i--;
            }
        }
